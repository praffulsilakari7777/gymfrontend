...
import AllMembers_item from './AllMembers_item';
...
{/* <input type="text" placeholder="Search Member" onChange={(event) => setSearchTerm(event.target.value)} /> */}
<div className="center">
...
<pre></pre>
      ...
      <Table className={classes.table} aria-label="customized table">
        ...
        <TableBody>
           ...
           {props.items.filter((Class) => { if(searchTerm == ""){ 
                                            return Class }
                                          else if(Class.fullname.toLowerCase().includes(searchTerm.toLowerCase())){
                                            return Class;
                                          }  }).map(Class => (
    ...
    <pre></pre>
    <h5>Total Mebers - {props.items.length}</h5>
    {/* </ul> */}
