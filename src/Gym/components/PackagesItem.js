  ...
  const classes = useStyles();
    ...
    const handleClickOpen1 = () => {
      ...
      const confirmDeleteHandler1 =  async () => {
          ...
          setOpen1(false);
          try {
            await sendRequest(`${process.env.REACT_APP_BACKEND_URL}/gym/deletepackage/${props.id}`, 'DELETE');
    ...
    return (
        ...
        <DialogTitle id="alert-dialog-title">{"Do you want to proceed and delete this package?"}</DialogTitle>
        <DialogContent>
      ...
      <tr>
              ...
              {props.month} {props.month>1?'Months':'Month'}
                </td>
                <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                ...
                {auth.role==='admin' && (<> <td>
                <Link to={`/updatepackage/${props.id}`}><button
