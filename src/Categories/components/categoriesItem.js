    ...
    return (
      ...
      {/* <HelmetProvider>
        ...
        <div className="user-item">
           ...
           <b> <Typography gutterBottom variant="body2">{props.categoryName}</Typography></b>
            <Typography variant="body2" gutterBottom>{props.filesCount} {props.filesCount === 1 ? 'file' : 'files'}
            </Typography>

            </div>
            <div className="user-item__imageL">
                <Avatar image={`https://cdn.iconscout.com/icon/free/png-512/buffer-3-457932.png`} alt={props.classNo} />
            </div>
        </Link>
